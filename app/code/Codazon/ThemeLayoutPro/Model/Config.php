...
class Config extends \Magento\Framework\DataObject
{
    ...
    public function __construct(
        ...
        \Codazon\ThemeLayoutPro\Model\Config\Loader $configLoader,
        \Codazon\ThemeLayoutPro\Model\Config\ThemeConfigValueFactory $configValueFactory,
    ...
    public function save()
    {
        ...
        try {
            ...
            $this->_eventManager->dispatch(
                "admin_theme_config_changed_section_{$this->getSection()}",
    ...
    protected function _processGroup(
        ...
        if (isset($groupData['fields'])) {
            ...
            foreach ($groupData['fields'] as $fieldId => $fieldData) {
                ...
                $backendModel->setThemeId($themeId);
    ...
    {
        $extended = $this->_configLoader->getConfigByPath($path, $this->getScope(), $this->getScopeId(), $this->getThemeId(), $full);
