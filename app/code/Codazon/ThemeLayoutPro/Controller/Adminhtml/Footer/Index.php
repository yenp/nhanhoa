...
class Index extends \Codazon\ThemeLayoutPro\Controller\Adminhtml\ThemeLayoutAbstract
{
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Footer'), __('Footer'));
        $resultPage->setActiveMenu('Codazon_ThemeLayoutPro::footer');
        $resultPage->getConfig()->getTitle()->prepend(__('Page Footer'));
        return $resultPage;
    }
    
    protected function _isAllowed()
    {
        return $this->_authorization->isAllowed('Codazon_ThemeLayoutPro::footer');
    }
}
