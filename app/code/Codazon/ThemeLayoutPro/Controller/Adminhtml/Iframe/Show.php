 ...
 */
namespace Codazon\ThemeLayoutPro\Controller\Adminhtml\Iframe;
...
class Show extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Codazon_ThemeLayoutPro::iframe';
    ...
    public function __construct(
        ...
        \Codazon\ThemeLayoutPro\Helper\Media $swatchHelper,
    ...
    public function execute()
    {
        try {
            ...
            $this->_eventManager->dispatch(
                'themelayoutpro_upload_image_after',
