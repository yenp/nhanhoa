	...
	protected function _prepareForm()
    {
		...
		$fieldset->addField(
			...
			[
				...
				'name' => 'type',
				'required' => true,
				'options' => ['0' => __('Horizontal'), '1' => __('Vertical'), '2' => __('Toggle')],
			]
		);
		$fieldset->addField(
			'css_class',
		...
		$fieldset->addField(
			...
			[
				...
				'name' => 'dropdown_style',
				'options' => ['auto_width' => 'Auto Width', 'full_width' => __('Full Width')],
				'required' => false
			]
		);
		$fieldset->addField(
		...
		$stylesVars = ['css_class','dropdown_animation','dropdown_style'];
