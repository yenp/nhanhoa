...
class Interceptor extends \Magento\Downloadable\Block\Catalog\Product\Samples implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasSamples');
        return $pluginInfo ? $this->___callPlugins('hasSamples', func_get_args(), $pluginInfo) : parent::hasSamples();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSamples');
        return $pluginInfo ? $this->___callPlugins('getSamples', func_get_args(), $pluginInfo) : parent::getSamples();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSampleUrl');
        return $pluginInfo ? $this->___callPlugins('getSampleUrl', func_get_args(), $pluginInfo) : parent::getSampleUrl($sample);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSamplesTitle');
        return $pluginInfo ? $this->___callPlugins('getSamplesTitle', func_get_args(), $pluginInfo) : parent::getSamplesTitle();
    }
