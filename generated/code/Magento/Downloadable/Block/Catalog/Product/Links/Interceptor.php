...
class Interceptor extends \Magento\Downloadable\Block\Catalog\Product\Links implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLinksPurchasedSeparately');
        return $pluginInfo ? $this->___callPlugins('getLinksPurchasedSeparately', func_get_args(), $pluginInfo) : parent::getLinksPurchasedSeparately();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLinkSelectionRequired');
        return $pluginInfo ? $this->___callPlugins('getLinkSelectionRequired', func_get_args(), $pluginInfo) : parent::getLinkSelectionRequired();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasLinks');
        return $pluginInfo ? $this->___callPlugins('hasLinks', func_get_args(), $pluginInfo) : parent::hasLinks();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrencyPrice');
        return $pluginInfo ? $this->___callPlugins('getCurrencyPrice', func_get_args(), $pluginInfo) : parent::getCurrencyPrice($price);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLinkSampleUrl');
        return $pluginInfo ? $this->___callPlugins('getLinkSampleUrl', func_get_args(), $pluginInfo) : parent::getLinkSampleUrl($link);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLinksTitle');
        return $pluginInfo ? $this->___callPlugins('getLinksTitle', func_get_args(), $pluginInfo) : parent::getLinksTitle();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIsOpenInNewWindow');
        return $pluginInfo ? $this->___callPlugins('getIsOpenInNewWindow', func_get_args(), $pluginInfo) : parent::getIsOpenInNewWindow();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIsLinkChecked');
        return $pluginInfo ? $this->___callPlugins('getIsLinkChecked', func_get_args(), $pluginInfo) : parent::getIsLinkChecked($link);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLinkCheckedValue');
        return $pluginInfo ? $this->___callPlugins('getLinkCheckedValue', func_get_args(), $pluginInfo) : parent::getLinkCheckedValue($link);
    }
    ...
    public function getLinkPrice(\Magento\Downloadable\Model\Link $link)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getLinkPrice', func_get_args(), $pluginInfo) : parent::getLinkPrice($link);
    }
