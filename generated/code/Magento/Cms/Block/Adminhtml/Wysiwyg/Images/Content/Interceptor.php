...
class Interceptor extends \Magento\Cms\Block\Adminhtml\Wysiwyg\Images\Content implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContentsUrl');
        return $pluginInfo ? $this->___callPlugins('getContentsUrl', func_get_args(), $pluginInfo) : parent::getContentsUrl();
    }
    ...
    public function getFilebrowserSetupObject()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getFilebrowserSetupObject', func_get_args(), $pluginInfo) : parent::getFilebrowserSetupObject();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNewfolderUrl');
        return $pluginInfo ? $this->___callPlugins('getNewfolderUrl', func_get_args(), $pluginInfo) : parent::getNewfolderUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDeleteFilesUrl');
        return $pluginInfo ? $this->___callPlugins('getDeleteFilesUrl', func_get_args(), $pluginInfo) : parent::getDeleteFilesUrl();
    }
    ...
    public function getOnInsertUrl()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getOnInsertUrl', func_get_args(), $pluginInfo) : parent::getOnInsertUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTargetElementId');
        return $pluginInfo ? $this->___callPlugins('getTargetElementId', func_get_args(), $pluginInfo) : parent::getTargetElementId();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'removeButton');
        return $pluginInfo ? $this->___callPlugins('removeButton', func_get_args(), $pluginInfo) : parent::removeButton($buttonId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'updateButton');
        return $pluginInfo ? $this->___callPlugins('updateButton', func_get_args(), $pluginInfo) : parent::updateButton($buttonId, $key, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getButtonsHtml');
        return $pluginInfo ? $this->___callPlugins('getButtonsHtml', func_get_args(), $pluginInfo) : parent::getButtonsHtml($region);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHeaderHtml');
        return $pluginInfo ? $this->___callPlugins('getHeaderHtml', func_get_args(), $pluginInfo) : parent::getHeaderHtml();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasFooterButtons');
        return $pluginInfo ? $this->___callPlugins('hasFooterButtons', func_get_args(), $pluginInfo) : parent::hasFooterButtons();
    }
