<?php
namespace Magento\Cms\Controller\Adminhtml\Wysiwyg\Images\Index;

/**
 * Interceptor class for @see \Magento\Cms\Controller\Adminhtml\Wysiwyg\Images\Index
 */
class Interceptor extends \Magento\Cms\Controller\Adminhtml\Wysiwyg\Images\Index implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStorage');
        return $pluginInfo ? $this->___callPlugins('getStorage', func_get_args(), $pluginInfo) : parent::getStorage();
    }
