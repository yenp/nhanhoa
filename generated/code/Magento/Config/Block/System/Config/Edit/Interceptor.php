...
class Interceptor extends \Magento\Config\Block\System\Config\Edit implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSaveButtonHtml');
        return $pluginInfo ? $this->___callPlugins('getSaveButtonHtml', func_get_args(), $pluginInfo) : parent::getSaveButtonHtml();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConfigSearchParamsJson');
        return $pluginInfo ? $this->___callPlugins('getConfigSearchParamsJson', func_get_args(), $pluginInfo) : parent::getConfigSearchParamsJson();
    }
