<?php
namespace Magento\Config\Model\Config\Backend\Currency\Base;

/**
 * Interceptor class for @see \Magento\Config\Model\Config\Backend\Currency\Base
 */
class Interceptor extends \Magento\Config\Model\Config\Backend\Currency\Base implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $currencyFactory, $resource, $resourceCollection, $data);
    }
