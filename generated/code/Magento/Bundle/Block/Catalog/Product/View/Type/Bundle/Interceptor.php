...
class Interceptor extends \Magento\Bundle\Block\Catalog\Product\View\Type\Bundle implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getOptions($stripSelection = false)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getOptions', func_get_args(), $pluginInfo) : parent::getOptions($stripSelection);
    }
     ...
     * {@inheritdoc}
     */
    public function getOptionHtml(\Magento\Bundle\Model\Option $option)
    {
