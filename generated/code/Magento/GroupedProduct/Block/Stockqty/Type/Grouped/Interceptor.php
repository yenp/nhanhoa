...
class Interceptor extends \Magento\GroupedProduct\Block\Stockqty\Type\Grouped implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getChildProducts');
        return $pluginInfo ? $this->___callPlugins('getChildProducts', func_get_args(), $pluginInfo) : parent::getChildProducts();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDetailsPlaceholderId');
        return $pluginInfo ? $this->___callPlugins('getDetailsPlaceholderId', func_get_args(), $pluginInfo) : parent::getDetailsPlaceholderId();
    }
    ...
    public function getStockQty()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getStockQty', func_get_args(), $pluginInfo) : parent::getStockQty();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductStockQty');
        return $pluginInfo ? $this->___callPlugins('getProductStockQty', func_get_args(), $pluginInfo) : parent::getProductStockQty($product);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getThresholdQty');
        return $pluginInfo ? $this->___callPlugins('getThresholdQty', func_get_args(), $pluginInfo) : parent::getThresholdQty();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPlaceholderId');
        return $pluginInfo ? $this->___callPlugins('getPlaceholderId', func_get_args(), $pluginInfo) : parent::getPlaceholderId();
    }
