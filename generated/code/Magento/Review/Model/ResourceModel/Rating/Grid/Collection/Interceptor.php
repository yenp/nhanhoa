<?php
namespace Magento\Review\Model\ResourceModel\Rating\Grid\Collection;

/**
 * Interceptor class for @see \Magento\Review\Model\ResourceModel\Rating\Grid\Collection
 */
class Interceptor extends \Magento\Review\Model\ResourceModel\Rating\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactory $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Review\Model\ResourceModel\Rating\Option\CollectionFactory $ratingCollectionF, \Magento\Framework\Registry $coreRegistry, ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
        parent::__construct($entityFactory, $logger, $fetchStrategy, $eventManager, $storeManager, $ratingCollectionF, $coreRegistry, $connection, $resource);
    }
    ...
    public function _initSelect()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('_initSelect', func_get_args(), $pluginInfo) : parent::_initSelect();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addEntityFilter');
        return $pluginInfo ? $this->___callPlugins('addEntityFilter', func_get_args(), $pluginInfo) : parent::addEntityFilter($entity);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setPositionOrder');
        return $pluginInfo ? $this->___callPlugins('setPositionOrder', func_get_args(), $pluginInfo) : parent::setPositionOrder($dir);
    }
    ...
    public function setStoreFilter($storeId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setStoreFilter', func_get_args(), $pluginInfo) : parent::setStoreFilter($storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addOptionToItems');
        return $pluginInfo ? $this->___callPlugins('addOptionToItems', func_get_args(), $pluginInfo) : parent::addOptionToItems();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addEntitySummaryToItem');
        return $pluginInfo ? $this->___callPlugins('addEntitySummaryToItem', func_get_args(), $pluginInfo) : parent::addEntitySummaryToItem($entityPkValue, $storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRatingPerStoreName');
        return $pluginInfo ? $this->___callPlugins('addRatingPerStoreName', func_get_args(), $pluginInfo) : parent::addRatingPerStoreName($storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addStoreData');
        return $pluginInfo ? $this->___callPlugins('addStoreData', func_get_args(), $pluginInfo) : parent::addStoreData();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setActiveFilter');
        return $pluginInfo ? $this->___callPlugins('setActiveFilter', func_get_args(), $pluginInfo) : parent::setActiveFilter($isActive);
    }
