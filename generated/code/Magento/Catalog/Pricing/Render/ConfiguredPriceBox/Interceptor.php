...
class Interceptor extends \Magento\Catalog\Pricing\Render\ConfiguredPriceBox implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getPriceType($priceCode)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getPriceType', func_get_args(), $pluginInfo) : parent::getPriceType($priceCode);
    }

    /**
     * {@inheritdoc}
     */
    public function getConfiguredPrice() : \Magento\Framework\Pricing\Price\PriceInterface
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConfiguredPrice');
        return $pluginInfo ? $this->___callPlugins('getConfiguredPrice', func_get_args(), $pluginInfo) : parent::getConfiguredPrice();
    }

    /**
     * {@inheritdoc}
     */
    public function getConfiguredRegularPrice() : \Magento\Framework\Pricing\Price\PriceInterface
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConfiguredRegularPrice');
        return $pluginInfo ? $this->___callPlugins('getConfiguredRegularPrice', func_get_args(), $pluginInfo) : parent::getConfiguredRegularPrice();
    }
    ...
    public function hasSpecialPrice() : bool
    {
        ...
        return $pluginInfo ? $this->___callPlugins('hasSpecialPrice', func_get_args(), $pluginInfo) : parent::hasSpecialPrice();
    }
    ...
    public function renderAmountMinimal()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('renderAmountMinimal', func_get_args(), $pluginInfo) : parent::renderAmountMinimal();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isProductList');
        return $pluginInfo ? $this->___callPlugins('isProductList', func_get_args(), $pluginInfo) : parent::isProductList();
    }
    ...
    public function getSaleableItem()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getSaleableItem', func_get_args(), $pluginInfo) : parent::getSaleableItem();
    }
    ...
    public function getPriceId($defaultPrefix = null, $defaultSuffix = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getPriceId', func_get_args(), $pluginInfo) : parent::getPriceId($defaultPrefix, $defaultSuffix);
    }
    ...
    public function renderAmount(\Magento\Framework\Pricing\Amount\AmountInterface $amount, array $arguments = [])
    {
        ...
        return $pluginInfo ? $this->___callPlugins('renderAmount', func_get_args(), $pluginInfo) : parent::renderAmount($amount, $arguments);
    }
    ...
    public function getRendererPool()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getRendererPool', func_get_args(), $pluginInfo) : parent::getRendererPool();
    }
