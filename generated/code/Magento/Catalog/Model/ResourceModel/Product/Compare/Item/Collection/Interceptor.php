...
class Interceptor extends \Magento\Catalog\Model\ResourceModel\Product\Compare\Item\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setVisitorId');
        return $pluginInfo ? $this->___callPlugins('setVisitorId', func_get_args(), $pluginInfo) : parent::setVisitorId($visitorId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConditionForJoin');
        return $pluginInfo ? $this->___callPlugins('getConditionForJoin', func_get_args(), $pluginInfo) : parent::getConditionForJoin();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_addJoinToSelect');
        return $pluginInfo ? $this->___callPlugins('_addJoinToSelect', func_get_args(), $pluginInfo) : parent::_addJoinToSelect();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getComparableAttributes');
        return $pluginInfo ? $this->___callPlugins('getComparableAttributes', func_get_args(), $pluginInfo) : parent::getComparableAttributes();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'loadComparableAttributes');
        return $pluginInfo ? $this->___callPlugins('loadComparableAttributes', func_get_args(), $pluginInfo) : parent::loadComparableAttributes();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'useProductItem');
        return $pluginInfo ? $this->___callPlugins('useProductItem', func_get_args(), $pluginInfo) : parent::useProductItem();
    }
