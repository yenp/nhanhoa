...
class Interceptor extends \Magento\Catalog\Block\Product\Compare\ListCompare implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getProductAttributeValue($product, $attribute)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getProductAttributeValue', func_get_args(), $pluginInfo) : parent::getProductAttributeValue($product, $attribute);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasAttributeValueForProducts');
        return $pluginInfo ? $this->___callPlugins('hasAttributeValueForProducts', func_get_args(), $pluginInfo) : parent::hasAttributeValueForProducts($attribute);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPrintUrl');
        return $pluginInfo ? $this->___callPlugins('getPrintUrl', func_get_args(), $pluginInfo) : parent::getPrintUrl();
    }
    ...
    public function getProductPrice(\Magento\Catalog\Model\Product $product, $idSuffix = '')
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getProductPrice', func_get_args(), $pluginInfo) : parent::getProductPrice($product, $idSuffix);
    }
