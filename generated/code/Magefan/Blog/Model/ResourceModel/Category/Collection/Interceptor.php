<?php
namespace Magefan\Blog\Model\ResourceModel\Category\Collection;

/**
 * Interceptor class for @see \Magefan\Blog\Model\ResourceModel\Category\Collection
 */
class Interceptor extends \Magefan\Blog\Model\ResourceModel\Category\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGroupedChilds');
        return $pluginInfo ? $this->___callPlugins('getGroupedChilds', func_get_args(), $pluginInfo) : parent::getGroupedChilds();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTreeOrderedArray');
        return $pluginInfo ? $this->___callPlugins('getTreeOrderedArray', func_get_args(), $pluginInfo) : parent::getTreeOrderedArray();
    }
