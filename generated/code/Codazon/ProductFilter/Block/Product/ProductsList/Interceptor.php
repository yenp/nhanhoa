...
class Interceptor extends \Codazon\ProductFilter\Block\Product\ProductsList implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getObjectManager');
        return $pluginInfo ? $this->___callPlugins('getObjectManager', func_get_args(), $pluginInfo) : parent::getObjectManager();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUrlHelper');
        return $pluginInfo ? $this->___callPlugins('getUrlHelper', func_get_args(), $pluginInfo) : parent::getUrlHelper();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getListProduct');
        return $pluginInfo ? $this->___callPlugins('getListProduct', func_get_args(), $pluginInfo) : parent::getListProduct();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductListBlock');
        return $pluginInfo ? $this->___callPlugins('getProductListBlock', func_get_args(), $pluginInfo) : parent::getProductListBlock();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'subString');
        return $pluginInfo ? $this->___callPlugins('subString', func_get_args(), $pluginInfo) : parent::subString($str, $strLenght);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getElementShow');
        return $pluginInfo ? $this->___callPlugins('getElementShow', func_get_args(), $pluginInfo) : parent::getElementShow();
    }
    ...
    public function isShow($item)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('isShow', func_get_args(), $pluginInfo) : parent::isShow($item);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBlockId');
        return $pluginInfo ? $this->___callPlugins('getBlockId', func_get_args(), $pluginInfo) : parent::getBlockId();
    }
    ...
    public function getFilterData()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getFilterData', func_get_args(), $pluginInfo) : parent::getFilterData();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSliderData');
        return $pluginInfo ? $this->___callPlugins('getSliderData', func_get_args(), $pluginInfo) : parent::getSliderData();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGridData');
        return $pluginInfo ? $this->___callPlugins('getGridData', func_get_args(), $pluginInfo) : parent::getGridData();
    }
    ...
    public function getProductDefaultQty($product)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getProductDefaultQty', func_get_args(), $pluginInfo) : parent::getProductDefaultQty($product);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSwatchesBlock');
        return $pluginInfo ? $this->___callPlugins('getSwatchesBlock', func_get_args(), $pluginInfo) : parent::getSwatchesBlock();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImageHtml');
        return $pluginInfo ? $this->___callPlugins('getImageHtml', func_get_args(), $pluginInfo) : parent::getImageHtml($product, $width, $height, $imageHelper);
    }

    /**
     * {@inheritdoc}
     */
    public function getProductPriceHtml(\Magento\Catalog\Model\Product $product, $priceType = null, $renderZone = 'item_list', array $arguments = [])
    {
    ...
    public function getProductsCount()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getProductsCount', func_get_args(), $pluginInfo) : parent::getProductsCount();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductsPerPage');
        return $pluginInfo ? $this->___callPlugins('getProductsPerPage', func_get_args(), $pluginInfo) : parent::getProductsPerPage();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'showPager');
        return $pluginInfo ? $this->___callPlugins('showPager', func_get_args(), $pluginInfo) : parent::showPager();
    }
    ...
    public function getPagerHtml()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getPagerHtml', func_get_args(), $pluginInfo) : parent::getPagerHtml();
    }
