...
/**
 * Proxy class for @see \Codazon\ThemeLayoutPro\Model\Config\ResourceModel\Config\Data\Collection
 */
class Proxy extends \Codazon\ThemeLayoutPro\Model\Config\ResourceModel\Config\Data\Collection implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * Proxied instance
     *
     * @var \Codazon\ThemeLayoutPro\Model\Config\ResourceModel\Config\Data\Collection
     */
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Codazon\\ThemeLayoutPro\\Model\\Config\\ResourceModel\\Config\\Data\\Collection', $shared = true)
    {
    ...
    {
        return $this->_getSubject()->addScopeFilter($scope, $scopeId, $section);
    }
    ...
    {
        return $this->_getSubject()->addPathFilter($section);
    }
