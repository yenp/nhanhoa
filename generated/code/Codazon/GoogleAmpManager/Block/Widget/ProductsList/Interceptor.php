...
class Interceptor extends \Codazon\GoogleAmpManager\Block\Widget\ProductsList implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'displayOnListing');
        return $pluginInfo ? $this->___callPlugins('displayOnListing', func_get_args(), $pluginInfo) : parent::displayOnListing($item);
    }
