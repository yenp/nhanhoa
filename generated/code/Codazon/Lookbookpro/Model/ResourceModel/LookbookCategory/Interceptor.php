...
class Interceptor extends \Codazon\Lookbookpro\Model\ResourceModel\LookbookCategory implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLookbooksPosition');
        return $pluginInfo ? $this->___callPlugins('getLookbooksPosition', func_get_args(), $pluginInfo) : parent::getLookbooksPosition($category);
    }
     ...
     * {@inheritdoc}
     */
    public function changeParent(\Codazon\Lookbookpro\Model\LookbookCategory $category, \Codazon\Lookbookpro\Model\LookbookCategory $newParent, $afterCategoryId = null)
    {
