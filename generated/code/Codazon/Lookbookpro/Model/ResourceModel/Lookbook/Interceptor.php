...
class Interceptor extends \Codazon\Lookbookpro\Model\ResourceModel\Lookbook implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemsPosition');
        return $pluginInfo ? $this->___callPlugins('getItemsPosition', func_get_args(), $pluginInfo) : parent::getItemsPosition($lookbook);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLookbookItemGroupTable');
        return $pluginInfo ? $this->___callPlugins('getLookbookItemGroupTable', func_get_args(), $pluginInfo) : parent::getLookbookItemGroupTable();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLookbookCategoryTable');
        return $pluginInfo ? $this->___callPlugins('getLookbookCategoryTable', func_get_args(), $pluginInfo) : parent::getLookbookCategoryTable();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoriesPosition');
        return $pluginInfo ? $this->___callPlugins('getCategoriesPosition', func_get_args(), $pluginInfo) : parent::getCategoriesPosition($lookbook);
    }
