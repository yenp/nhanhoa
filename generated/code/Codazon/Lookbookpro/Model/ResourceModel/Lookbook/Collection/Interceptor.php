<?php
namespace Codazon\Lookbookpro\Model\ResourceModel\Lookbook\Collection;

/**
 * Interceptor class for @see \Codazon\Lookbookpro\Model\ResourceModel\Lookbook\Collection
 */
class Interceptor extends \Codazon\Lookbookpro\Model\ResourceModel\Lookbook\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setJoinField');
        return $pluginInfo ? $this->___callPlugins('setJoinField', func_get_args(), $pluginInfo) : parent::setJoinField($table, $field);
    }
